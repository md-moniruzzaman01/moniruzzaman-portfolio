...
const FooterLink: React.FC<{
  ...
  <a
    href={href}
    className={`block text-md  md:text-2xl font-extrabold text-white hover:text-cyan-400 transition-colors duration-200 py-1 ${className}`}
  >
    {text}
  </a>
);
  ...
  return (
    <footer className="bg-gray-950 pt-24 pb-8 px-6 font-inter">
      <div className="container mx-auto max-w-7xl">
          ...
          <div>
            ...
            <div className="space-y-4">
              <a
                ...
                className="block text-sm md:text-2xl font-extrabold text-indigo-400 hover:text-indigo-300 transition-colors py-1 wrap-anywhere"
              >
                dev.moniruzzaman@gmail.com
              </a>
              <p className="text-sm font-light text-gray-400 max-w-xs">
                Interested in collaborating? Let’s create something
        ...
        {/* Bottom Row */}
        <div className="grid grid-cols-1 md:grid-cols-4 pt-4  border-gray-800 pb-10 ">
          <div className="col-span-1 text-xs font-mono tracking-wide text-gray-600 uppercase text-center md:text-start">
            <p>
          ...
          <div className=" col-span-1 text-xs font-mono tracking-wide text-gray-600 uppercase flex items-center justify-center md:justify-start">
          ...
          <div className="col-span-1 md:col-span-2 text-xs font-mono tracking-widest text-gray-600 uppercase  text-center md:text-right">
        ...
        {/* <div className="pt-2">
                    <h1 className="text-[5rem] sm:text-[3rem] md:text-[15rem] lg:text-[20rem] font-extrabold leading-none text-gray-900 select-none textZoom">
                        Moniruzzaman
                    </h1>
                </div> */}
      </div>

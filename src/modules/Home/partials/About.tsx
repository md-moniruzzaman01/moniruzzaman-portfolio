          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="pt-4">
              <p className="text-muted-foreground text-sm italic">
                Trusted by high-growth startups and established brands in{" "}
          ...
          >
            <div className="space-y-4">
              <p className="text-primary text-sm font-display tracking-wider uppercase">
                Affordable, High-Impact Web Development Solutions for New York
                Small Businesses
              </p>
              <h2 className="text-4xl md:text-5xl font-display font-bold leading-tight">
                Creating{" "}
                <span className="text-gradient">High-Impact Websites</span> That
                Drive Growth
              </h2>
            </div>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              I help NYC small businesses enhance their online presence, attract
              more customers, and achieve measurable results. Every website I
              build focuses on{" "}
              <strong>
                performance, usability, and conversion optimization
              </strong>{" "}
              to turn visitors into loyal clients.
            </p>
